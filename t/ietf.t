...
$locale = IETF::Locale->from_string('en');
...
$locale = IETF::Locale->from_string('en-US');
is $locale->primary_language, 'en';
is $locale->region,           'US';

$locale = IETF::Locale->from_string('ar-Cyrl-CO');
is $locale->primary_language, 'ar';
is $locale->script,           'Cyrl';
is $locale->region,           'CO';

$locale = IETF::Locale->from_string('tlh-Kore-AQ-fonipa');
